...
import ch.ahoegger.scout.example.scoutjs.client.search.SearchOutline;
import ch.ahoegger.scout.example.scoutjs.client.settings.SettingsOutline;
import ch.ahoegger.scout.example.scoutjs.client.work.WorkOutline;
